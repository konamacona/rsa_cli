/*
 * This is an external implementation of the BigInteger Class
 * Which I assume was authored by Scott Garland
 * Taken from: https://biginteger.codeplex.com/
 * Some changes made to upgrade to DNX 5, search 'Mitch'
 */
...
namespace ScottGarland
{
    ...
    public class BigInteger
    {
        ...
        private void Construct(string digits, int radix)
        {
            ...
            //Mitch - toUpper Fails for some reason with an argument
        ...
        public string ToString(int radix)
        {
            ...
            //Mitch - ArrayList is apparently non-existent
            ...
            string result = new String((char[])al.ToArray());
